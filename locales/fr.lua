...
Locale.register('fr', {
    ...
    ['anchor.dropped']              = "Ancre jetée. Ce bateau ne bougera plus.",
    ['anchor.raised']               = "Ancre remontée.",
    ['anchor.no_vehicle']           = "Monte dans le bateau que tu veux ancrer.",
    ['anchor.wrong_class']          = "Ce véhicule n'a pas d'ancre.",
    ['anchor.not_kept']             = "Ce véhicule n'est pas conservé par v-park, une ancre ne survivrait pas à un redémarrage.",
    ['anchor.disabled']             = "Les ancres sont désactivées sur ce serveur.",
    ...
    ['props.live_paint']   = "  live      couleurs %s  mod1 %s  mod2 %s  extra %s  custom %s",
    ['props.stored_paint'] = "  stored    couleurs %s  mod1 %s  mod2 %s  extra %s  custom %s",
    ['props.stored_deformation'] = "  stored    points de deformation %s",
    ['props.live_engine']  = "  live      sante moteur %s",
    ['props.live_smoke']   = "  live      fumee de pneus %s  couleur %s",
    ['props.stored_smoke'] = "  stored    fumee de pneus %s  couleur %s",
    ['panel.last_garage']  = "Dernier garage",
    ...
    ['sync.nobody']   = "personne n'est connecté.",
    ['sync.header']   = "synchronisation, %d joueur(s), du pire au meilleur :",
    ['sync.row']      = "%s %s (%s)  ping %d ms  fps %s  incidents %d  nommé %d  répondu %d/%d",
    ['sync.reason']   = "      dernier incident : %s",
    ['sync.legend']   = "un `!` signifie que v-park écarte ce joueur quand un autre est à proximité. Les incidents expirent.",

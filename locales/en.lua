...
Locale.register('en', {
    ...
    ['props.live_extras'] = '  live      extras %s  network control %s',
    ['props.stored_extras'] = '  stored    extras %s  restore pending %s  saving enabled %s',
    ...
    ['props.live_smoke']   = '  live      tyre smoke on %s  colour %s',
    ['props.stored_smoke'] = '  stored    tyre smoke on %s  colour %s',
    ['panel.last_garage']  = 'Last garage',
    ...
    ['sync.nobody']   = 'nobody is connected.',
    ['sync.header']   = 'synchronisation, %d player(s), worst first:',
    ['sync.row']      = '%s %s (%s)  ping %d ms  fps %s  strikes %d  nominated %d  answered %d/%d',
    ['sync.reason']   = '      last strike: %s',
    ['sync.legend']   = 'a `!` means v-park passes this player over when somebody else is near. Strikes expire.',
    ['stats.changes'] = 'most changed on capture: %s',
    ['stats.quality'] = 'sync quality: %d player(s) struggling now, %d nomination(s) handed to a better player',
